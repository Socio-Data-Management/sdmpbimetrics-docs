...
|----------|-------------|---------|
| **Score measure** | *(mandatory)* The group's value at each step — see [Data Roles](../getting-started/data-roles#score-base-comparison-comparison-base--what-they-mean) | — |
| **Base measure** | Respondent/sample count at each step (denominator for significance testing) | — |
| **Comparison measure** | Reference Score to test against — a segment average, another category, another year… | — |
| **Comparison base measure** | The comparison's respondent/sample count | — |
